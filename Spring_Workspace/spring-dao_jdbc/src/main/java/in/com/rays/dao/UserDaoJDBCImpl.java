...
public class UserDaoJDBCImpl implements UserDAOInt {
	...
	public UserDTO findByLogin(String login) {
		// TODO Auto-generated method stub
		String sql = "SELECT ID , FIRSTNAME , LASTNAME , LOGINID, PASSWORD ,FROM USER WHERE LOGINID = ?";
		Object[] param = { login };
	...
	public UserDTO authenticate(String login, String password) {
		// TODO Auto-generated method stub
		String sql = "SELECT ID, FIRSTNAME , LASTNAME , LOGINID, PASSWORD FORM USER WHERE LOGINID = ? AND PASSWORD =?";
